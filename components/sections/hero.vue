<template>
  <Section id="hero" :fullHeight="true">
    <div class="flex flex-col justify-center h-full text-center relative">
      <h1
        class="home-title text-typography_primary_light dark:text-typography_primary_dark"
      >
        Hi! My name is
        <span
          class="impact text-brand_primary_light dark:text-brand_primary_dark"
          >Florencia Petrikovich</span
        >
      </h1>
      <h2
      ...
      >
        ...
        <span
          class="impact text-brand_primary_light dark:text-brand_primary_dark"
          >Software Engineer (BS, MEng)</span
        >
        experienced in
        <span
          class="impact text-brand_primary_light dark:text-brand_primary_dark"
        ...
        <span
          class="impact text-brand_primary_light dark:text-brand_primary_dark"
          >energetic learner</span
        >
        driven by curiosity and a
        <span
          class="impact text-brand_primary_light dark:text-brand_primary_dark"
          >passion for growth</span
        >.
      </h2>
      <div class="mt-8 mx-auto flex flex-col md:flex-row">
        ...
        <ButtonsButton
          text="Get My CV"
          format="primary"
          href="/Florencia-Petrikovich-Software_Engineer-CV.pdf"
          target="_blank"
